...
<body
    ...
    <div style="display: none;">A request to reset password was received from your {{ config('app.name') }} Account
    </div>
                                ...
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="margin: 0 0 24px;">Use this link to reset your password and login.
                                            </p>
                                            <a href="{{ $actionUrl }}"
                                            ...
                                            <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0 !important; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                                            ...
                                            <p style="margin: 0;">
                                                ...
                                                <a href="mailto:{{ config('app.support.email') }}"
                                                    ...
                                                    style="--text-opacity: 1 !important; color: #7367f0 !important; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">{{ config('app.support.email') }}</a>
                                            </p>
                                            ...
                                            <p style="margin: 0 0 16px;">Thanks, <br>The {{ config('app.name') }}
                                                Team
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @isset($actionText)
                                            @lang("If you're having trouble clicking the \":actionText\" button, copy and paste the URL below\n" . 'into your web browser:', [
                                                ...
                                                class="break-all">[{{ $displayableActionUrl }}]</span>
                                        @endisset
                                    </tr>
                                    <tr>
