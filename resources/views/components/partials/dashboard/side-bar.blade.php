        ...
        <div class="multinav">
            <div class="multinav-scroll" style="height: 97%;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="jobs.html"><i class="icon-Commit"><span class="path1"></span><span
                                            class="path2"></span></i>Jobs List</a></li>
                            <li><a href="jobs_details.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Jobs
                                    Details</a></li>
                            <li><a href="applications.html"><i class="icon-Commit"><span
                                            class="path1"></span><span
                                            class="path2"></span></i>Applications</a></li>
                            <li><a href="extra_profile.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Profile</a>
                            </li>
                            <li><a href="billing.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Billing</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                ...
                <div class="sidebar-widgets">
                    <div class="pb-20 mx-25 mb-30 side-bx bg-primary-light rounded20">
                        <div class="text-center">
                            <img src="../../../images/svg-icon/color-svg/custom-30.svg" class="p-5 sideimg"
                                alt="">
