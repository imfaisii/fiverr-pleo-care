                    ...
                    <div class="box overflow-h">
                        <div class="box-body" style="height:18rem;">
                            ...
                            <div>
                                <a href="mailbox.html"
                                    class="mt-5 btn btn-primary-light d-flex justify-content-between align-items-center">
                                    <span class="text-overflow pe-5"><i class="fa fa-commenting-o me-10"></i><span
                                            class="fw-600">4</span>
                                        New Messages </span>
                                    <i class="fa fa-arrow-right"></i>
                                </a>
            ...
            <div class="box" style="height:18rem;">
                <div class="box-body bb-1">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="badge badge-lg badge-warning-light me-10"><i class="me-5 fa fa-server"></i> 50
                            </div>
        ...
        <div class="col-xl-3 col-12">
            <div class="box" style="height: 37.2rem;">
                ...
                <div class="pt-0 box-body">
                    ...
                    <div class="p-10 mb-10 rounded bg-lightest d-flex align-items-center justify-content-between">
                        <h5 class="my-0 text-fade">Like (1st Level) <span class="fw-500 text-primary">(63%)</span>
                        </h5>
                        <h5 class="my-0 fw-500 text-primary">1,234</h5>
                    </div>
                    <div class="p-10 mb-10 rounded bg-lightest d-flex align-items-center justify-content-between">
                        <h5 class="my-0 text-fade">Like (2ed Level) <span class="fw-500 text-success">(19%)</span>
                        </h5>
