<div class="content-wrapper">
    <div class="container-full">
        ...
        <section class="content">
            <div class="row">
                <div class="order-2 col-xl-8 col-12 order-xl-1">
                    <div class="row">
                            ...
                            <div class="box overflow-h">
                                <div class="box-body" style="height:18rem;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <img src="../../../images/svg-icon/img-1.png"
                                            class="img-fluid max-w-150 image-1" alt="" />
                                    </div>
                                    <div>
                                        <a href="jobs.html"
                                            class="mt-5 btn btn-primary-light d-flex justify-content-between align-items-center">
                                            <span class="text-overflow pe-5"><i class="fa fa-file-text me-10"></i><span
                                                    class="fw-600">10</span> new jobs for you</span>
                            ...
                            <div class="box overflow-h">
                                <div class="box-body" style="height:18rem;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <img src="../../../images/svg-icon/img-2.png "
                                            class="img-fluid max-w-150 image-1" alt="" />
                                    </div>
                                    <div>
                                        <a href="jobs.html"
                                            class="mt-5 btn btn-primary-light d-flex justify-content-between align-items-center">
                                            <span class="text-overflow pe-5"><i class="fa fa-refresh me-10"></i><span
                                                    class="fw-600">3</span> essential courses</span>
                                            <i class="fa fa-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="box overflow-h">
                                <div class="box-body" style="height:18rem;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <img src="../../../images/svg-icon/img-3.png "
                                            class="img-fluid max-w-150 image-1" alt="" />
                                    </div>
                                    <div>
                                        <a href="mailbox.html"
                                            class="mt-5 btn btn-primary-light d-flex justify-content-between align-items-center">
                                            <span class="text-overflow pe-5"><i
                                                    class="fa fa-commenting-o me-10"></i><span class="fw-600">4</span>
                                                New Messages </span>
                                            <i class="fa fa-arrow-right"></i>
                                        </a>
                                    </div>
                ...
                <div class="order-1 col-xl-4 col-12 order-xl-2">
                    <div class="box" style="height:18rem;">
                        <div class="box-body bb-1">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="badge badge-lg badge-warning-light me-10"><i
                                            class="me-5 fa fa-server"></i> 50</div>
                                    <div class="badge badge-lg badge-primary-light"><a href="mailbox.html"><i
                        ...
                        <div class="py-10 box-footer">
                            <div class="d-flex align-items-center justify-content-between">
                                <p class="mb-0 fs-12 text-overflow">Next: Add your Experience</p>
                                <a href="extra_profile.html" class="waves-effect waves-light btn btn-primary">Finish
                                    Your Profile</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="box">
                                ...
                                <div class="box-footer no-border">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="p-10 text-center rounded b-1 me-10 w-p100"><span
                                                class="me-10 badge badge-xl badge-dot badge-primary"></span>
                                            Male</div>
                                        <div class="p-10 text-center rounded b-1 ms-10 w-p100"><span
                                                class="me-10 badge badge-xl badge-dot badge-success"></span>
                                            FeMale</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-12">
                            <div class="box">
                                ...
                                <div class="pb-0 box-body ps-0">
                                    <div class="ps-20 d-flex align-items-center justify-content-between">
                                        <div>
                                            <h5 class="mb-0 text-fade">Ongoing <span class="text-primary">24
                                                    Projects</span></h5>
                                        </div>
                                        <div class="px-3 py-2 text-center rounded bg-primary-light text-primary">
                                            <script>
                                ...
                                <div class="box-footer no-border">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="pb-10 mb-10 text-center rounded b-1 w-p100 text-overflow">
                                            <span class="badge badge-xl badge-dot badge-primary"></span>
                                            Upcoming
                                        </div>
                                        <div class="pb-10 mb-10 text-center rounded b-1 w-p100 text-overflow">
                                            <span class="badge badge-xl badge-dot badge-success"></span> In
                                            Progress
                                        </div>
                                        <div class="pb-10 mb-10 text-center rounded b-1 w-p100 text-overflow">
                                            <span class="badge badge-xl badge-dot badge-light"></span> Complate
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <div class="box" style="height: 10rem;">
                                <div class="py-0 box-bod">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div style="margin-left: 18px; ">
                                            <h5 class="text-fade">Applications</h5>
                                            <h2 class="mb-0 fw-500">132.0K</h2>
                                        </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box" style="height: 10rem;">
                                <div class="py-0 box-body box-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="text-fade">Shortlisted</h5>
                                            <h2 class="mb-0 fw-500">10.9k</h2>
                                        </div>
                                        <div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box" style="height: 10rem;">
                                <div class="py-0 box-body box-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="text-fade">On Hold</h5>
                                            <h2 class="mb-0 fw-500">03.1k</h2>
                                        </div>
                                ...
                                <div class="chart-switch legend d-flex align-items-center justify-content-start">
                                    <div class="d-flex me-15">
                                        <label class="switch switch-border switch-success">
                                            <input type="checkbox" checked="" onclick="toggleSeries(this)"
                                                value="Applications">
                            ...
                            <div class="d-flex justify-content-between my-15">
                                ...
                                <p class="mb-0">
                                    ...
                                    <a href="applications.html"
                                        class="mx-5 waves-effect waves-light btn btn-xs btn-outline btn-primary-light">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-12">
                            <div class="overflow-hidden box">
                                ...
                                <div class="p-0 box-body">
                                    <h1 class="pt-0 mt-0 ps-20 fw-500 text-success">215,5K</h1>
                        ...
                        <div class="col-xl-6 col-12">
                            <div class="overflow-hidden box">
                                ...
                                <div class="p-0 box-body">
                                    <h1 class="pt-0 mt-0 ps-20 fw-500 text-primary">815</h1>
                        ...
                        <div class="col-xl-6 col-12">
                            <div class="overflow-hidden box">
                                ...
                                <div class="p-0 box-body">
                                    <h1 class="pt-0 mt-0 ps-20 fw-500 text-info">153</h1>
                        ...
                        <div class="col-xl-6 col-12">
                            <div class="overflow-hidden box">
                                ...
                                <div class="p-0 box-body">
                                    <h1 class="pt-0 mt-0 ps-20 fw-500 text-warning">2154</h1>
                ...
                <div class="col-xl-3 col-12">
                    <div class="box" style="height: 37.2rem;">
                        <div class="px-0 box-body" style="min-height: 268px;">
                            <div id="revenue7" class="text-dark"></div>
                        </div>
                        <div class="pt-0 box-body">
                            <h5 class="mb-3 text-overflow">Where do my Likes come.</h5>
                            <div
                                class="p-10 mb-10 rounded bg-lightest d-flex align-items-center justify-content-between">
                                <h5 class="my-0 text-fade">Like (1st Level) <span
                                        class="fw-500 text-primary">(63%)</span></h5>
                                <h5 class="my-0 fw-500 text-primary">1,234</h5>
                            </div>
                            <div
                                class="p-10 mb-10 rounded bg-lightest d-flex align-items-center justify-content-between">
                                <h5 class="my-0 text-fade">Like (2ed Level) <span
                                        class="fw-500 text-success">(19%)</span></h5>
                                <h5 class="my-0 fw-500 text-success">745</h5>
                            </div>
                            <div class="p-10 rounded bg-lightest d-flex align-items-center justify-content-between">
                                <h5 class="my-0 text-fade">Like (3rd Level) <span
                                        class="fw-500 text-info">(12%)</span></h5>
                            ...
                            <div class="application-bx">
                                <div class="d-flex align-items-center mb-30">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 fw-500 text-overflow">
                                        <a href="extra_profile.html" class="mb-1 hover-primary fs-16">Sophia
                                            Doe</a>
                                        <span class="fs-12 text-overflow"><span class="text-fade">Applied
                                ...
                                <div class="d-flex align-items-center mb-30">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 fw-500 text-overflow">
                                        <a href="extra_profile.html" class="mb-1 hover-danger fs-16">Mason
                                            Clark</a>
                                        <span class="fs-12 text-overflow"><span class="text-fade">Applied
                                ...
                                <div class="d-flex align-items-center mb-30">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 fw-500 text-overflow">
                                        <a href="extra_profile.html" class="mb-1 hover-success fs-16">Emily
                                            Paton</a>
                                        <span class="fs-12 text-overflow"><span class="text-fade">Applied
                                ...
                                <div class="d-flex align-items-center mb-30">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 fw-500 text-overflow">
                                        <a href="extra_profile.html" class="mb-1 hover-info fs-16">Daniel
                                            Breth</a>
                                        <span class="fs-12 text-overflow"><span class="text-fade">Applied
                                ...
                                <div class="d-flex align-items-center mb-30">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 fw-500 text-overflow">
                                        <a href="extra_profile.html" class="mb-1 hover-primary fs-16">Theron
                                            Trump</a>
                                        <span class="fs-12 text-overflow"><span class="text-fade">Applied
                                                for</span> Advertising Intern</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center mb-30">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 fw-500 text-overflow">
                                        <a href="extra_profile.html" class="mb-1 hover-danger fs-16">Nil
                                            Yeager</a>
                                        <span class="fs-12 text-overflow"><span class="text-fade">Applied
                                                for</span> Project Coordinator</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 fw-500 text-overflow">
                                        <a href="extra_profile.html" class="mb-1 hover-success fs-16">Tyler
                                            Mark</a>
                                        <span class="fs-12 text-overflow"><span class="text-fade">Applied
                                                for</span> Layout Expert</span>
                                    </div>
