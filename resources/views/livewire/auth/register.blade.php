                    ...
                    <div class="bg-white rounded10 shadow-lg">
                        ...
                        <div class="p-40">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input wire:model.lazy='user.name' type="text"
                                            class="form-control ps-15 bg-transparent @error('user.name') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input wire:model.lazy='user.password_confirmation' type="password"
                                            class="form-control ps-15 bg-transparent @error('user.password_confirmation') is-invalid @enderror"
                                    ...
                                    <div class="col-12 text-center">
                                        <div class="mb-5 text-center">
                                            <button wire:click.prevent="store" wire:loading.attr="disabled"
                                                type="submit" class="btn btn-primary w-p100 mt-10">
                                                <i class="opacity-50 fa fa-fw fa-plus me-1"></i>REGISTER
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-fade">Already have an account?<a href="{{ route('login') }}"
                                        class="text-primary ms-5">Sign In</a></p>
                            </div>
